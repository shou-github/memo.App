           ...
           <!--トップページにもどる-->
            ...
            <div class="float-right">{!! Form::submit('Save', ['class' => 'btn btn-lg btn-primary']) !!}</div>
               ...
               <!--textareaの文字数表示-->
                <div class="form-group" style="font-size:30px;">  
                   <div class="form-inline float-right"  style="color:white;">
                    ...
                    <p style="font-size:30px;"> 
                       <button class="btn" style="background-color:#0000FF; color:white; margin-right:30px;" id="button1" type="button"><i class="fas fa-volume-up"></i> English</button>
                        <!--日本語-->
                ...
                <!--テキストエリア  -->
                <textarea contenteditable class="form-control" onkeyup="ShowLength(value);" name="content" cols="50" rows="14" id="content">{{ old('content', $memo->content) }}</textarea><br>
